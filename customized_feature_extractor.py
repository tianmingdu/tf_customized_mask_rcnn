...
class CustomizedFeatureExtractor(
  ...
  def __init__(self,
    ...
    super(CustomizedFeatureExtractor, self).__init__(
...
class FasterRCNNResnet20FeatureExtractor(CustomizedFeatureExtractor):
  ...
  def __init__(self,
    ...
    """
    super(FasterRCNNResnet20FeatureExtractor, self).__init__(
        'resnet_v1_20', customized_resnet.resnet_v1_20, is_training,
